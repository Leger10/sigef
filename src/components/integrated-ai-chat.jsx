  ...
  return (
    <div className="flex flex-col h-full max-w-2xl mx-auto">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 scroll-smooth">
        {isLoadingHistory && (
          <div className="text-center text-sm text-gray-400 py-4">Chargement de l'historique...</div>
        )}
        {messages.map((msg, i) => {
      ...
      <div className="p-4 border-t">
        ...
        <form onSubmit={handleSubmit} className="flex gap-2">
          ...
          <button
            ...
            className="rounded-lg border px-3 py-2 hover:bg-muted disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <input
            ...
            className="flex-1 rounded-lg border px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary bg-background"
            disabled={isStreaming || isLoadingHistory}
          />
          <button
            type="submit"
